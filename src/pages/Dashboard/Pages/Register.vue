    ...
    <div class="row d-flex justify-content-center">
      <div class="col-md-8">
        <div class="header-text">
          ...
          <h4>Start tracking your kitties today!</h4>
          <hr>
        </div>
      </div>
        ...
        <!--<fade-render-transition :duration="200">-->
          <!--<div class="media">-->
            ...
            <!--<div class="media-body">-->
              <!--<h4>It's Free</h4>-->
              <!--<p>Here you can write a feature description for the dashboard, let the users know what is the value that you give them.</p>-->
            <!--</div>-->
          <!--</div>-->
